...
export default async function AdminPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="text-xs uppercase tracking-[0.24em] text-slate-400">Dashboard</div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        <Link
          ...
          className="rounded-[1.6rem] border border-fuchsia-400/20 bg-fuchsia-400/10 p-6 transition hover:bg-fuchsia-400/15"
        >
          <div className="text-lg">分销商管理</div>
          <p className="mt-3 text-sm leading-7 text-fuchsia-100">
            管理分销商账户、密钥配置、状态启用与停用。
          </p>
        </Link>
        <Link
          href="/admin/orders"
